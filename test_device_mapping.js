  ...
  try {
    ...
    if (devicesSnapshot.empty) {
      ...
      devicesSnapshot.forEach(doc => {
        const data = doc.data();
        console.log(`   ID: ${doc.id}, Name: ${data.name || 'N/A'}, Data:`, data);
      });
    }
    ...
    if (vehiclesSnapshot.empty) {
      ...
      vehiclesSnapshot.forEach(doc => {
        const data = doc.data();
        console.log(`   ID: ${doc.id}, DeviceId: ${data.deviceId || 'N/A'}, Data:`, data);
      });
    }
    ...
    if (deviceQuery.empty) {
      ...
      if (vehicleQuery.empty) {
        ...
        console.log(`   ✅ Found vehicle: ID=${vehicleDoc.id}, Data:`, vehicleData);
      }
    }
