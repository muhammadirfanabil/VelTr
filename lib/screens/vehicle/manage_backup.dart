...
class _ManageVehicleState extends State<ManageVehicle> {
  ...
  void _handleAttachDeviceInForm(String deviceId) async {
    try {
      debugPrint('🚀 [DEBUG] _handleAttachDeviceInForm called with deviceId: $deviceId');
      debugPrint('🚀 [DEBUG] Current _selectedDeviceId before: $_selectedDeviceId');
      ...
      debugPrint('🚀 [DEBUG] _selectedDeviceId after setState: $_selectedDeviceId');
  ...
  void _handleUnattachFromVehicle(String deviceId, String? vehicleId) async {
    try {
      debugPrint('🚀 [DEBUG] _handleUnattachFromVehicle called with deviceId: $deviceId, vehicleId: $vehicleId');
      debugPrint('🚀 [DEBUG] Current _selectedDeviceId before: $_selectedDeviceId');
  ...
  bool _hasDeviceChanges() {
    ...
    debugPrint('🚀 [DEBUG] _hasDeviceChanges: selected=$_selectedDeviceId, original=$_originalDeviceId, hasChanges=$hasChanges');
    return hasChanges;
  }
  ...
  Widget _buildSelectButton(Device device) {
    ...
    debugPrint('🚀 [DEBUG] _buildSelectButton for device ${device.id}: willAttach=$willAttach, _selectedDeviceId=$_selectedDeviceId');
    
    return AnimatedContainer(
      duration: const Duration(milliseconds: 300),
      child: ElevatedButton.icon(
        onPressed: () {
          debugPrint('🚀 [DEBUG] Select button pressed for device: ${device.id}');
